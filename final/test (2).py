...
def calculate_fourier_series():
    ...
    print("Enter your function in terms of x: x**2")
    print("Enter values of t: 0.25")

    func_str = "x**2"
    T = 2 * math.pi
    N = 5

    user_func = lambda x: eval(func_str, {'x': x})
...
def solve_trigonometric_equation():
    print("\nExample for Trigonometric Equation:")
    print("Enter the trigonometric equation in terms of x: sin(x)-0.5")
    print("Enter lower limit (a): 0")
    print("Enter upper limit (b): 1")
...
def integral_calc():
    print("Example for Integral:")
    print("Enter the function: x**2")
    print("Enter lower limit (a): -1")
    print("Enter upper limit (b): 1")
    ...
    num_subintervals = 20
    func = lambda x: eval(function_str, {'x': x})
...
def double_integral_calc():
    ...
    print("Enter the function: x**2*y")
    print("Enter lower limit for x: -1")
    print("Enter upper limit for x: 1")
    print("Enter lower limit for y: 0")
    print("Enter upper limit for y: 1")
    ...
    func = lambda x, y: eval(function_str, {'x': x, 'y': y})
...
def number_factorization_operations():
    ...
    print("\nExample for Factors:")
    print("Enter a number for factors: 24")
    ...
    print("Enter number for prime factor: 36")
...
def calculate_limit():
    print("\nExample for Limits:")
    print("Enter your function in terms of x: x**2")
    print("Enter the limit point (x): 2")
    print("Enter the approach direction ('both', 'positive', or 'negative'): both")

    user_func = lambda x: x**2

    limit_point = 2
    approach_direction = 'both'
...
def polynomials_menu():
    print("\nExample for Cubic Equation:")
    print("Enter the coefficients of the equation (up to 4). For a cubic equation, enter 4 coefficients.")
    print("Enter coefficients separated by space: 1 -6 11 -6")

    coeffs_cubic = [1, -6, 11, -6]  # coefficients for x^3 - 6x^2 + 11x - 6 = 0
    roots_cubic = solve_cubic(*coeffs_cubic)
    print(f"The roots of the cubic equation are: {roots_cubic}")
...
def taylor_series_menu():
    ...
    print("Enter a function of x (e.g., 'x**3 + sin(x)'): x**3+sin(x)")
    print("Enter the order of the Taylor series: 4")
    print("Enter the point x0: 0")
